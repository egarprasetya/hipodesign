...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			@la_access("Alas", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/alas/'.$ala->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Alas", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.alas.destroy', $ala->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/alas') }}" data-toggle="tooltip" data-placement="right" title="Back to Alas"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'NamaAlas')
						@la_display($module, 'Keterangan')
						@la_display($module, 'Harga')
						@la_display($module, 'GambarAlas')
					</div>
				</div>
			</div>
		</div>
