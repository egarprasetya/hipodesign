...
class CreateAlasTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Alas", 'alas', 'NamaAlas', 'fa-cube', [
            ["NamaAlas", "Nama Alas", "String", false, "", 0, 256, false],
            ["Keterangan", "Keterangan", "Textarea", false, "", 0, 0, false],
            ["Harga", "Harga", "String", false, "", 0, 256, false],
            ["GambarAlas", "Gambar Alas", "Image", false, "", 0, 0, false],
        ]);
