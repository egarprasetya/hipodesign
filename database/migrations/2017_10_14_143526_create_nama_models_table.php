...
class CreateNamaModelsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Nama_models", 'nama_models', 'NamaModel', 'fa-cube', [
            ["NamaModel", "Nama Model", "String", false, "", 0, 256, false],
    ...
    {
        if (Schema::hasTable('nama_models')) {
            Schema::drop('nama_models');
        }
    }
}
