...
class CreateMediaTanamsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Media_tanams", 'media_tanams', 'Kelebihan', 'fa-leaf', [
            ["NamaMedia", "Nama Media", "String", false, "", 1, 20, false],
            ["Keterangan", "Keterangan", "Textarea", false, "", 0, 0, false],
            ["Harga", "Harga", "String", false, "", 0, 256, false],
        ]);
    ...
    {
        if (Schema::hasTable('media_tanams')) {
            Schema::drop('media_tanams');
        }
    }
}
